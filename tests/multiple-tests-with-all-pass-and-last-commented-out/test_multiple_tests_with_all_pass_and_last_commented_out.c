...
#include "multiple_tests_with_all_pass_and_last_commented_out.h"

/*
This test is special because the last test is commented out on purpose.
*/
...
int main(void)
{
   UnityBegin("test_multiple_tests_with_all_pass_and_last_commented_out.c");
